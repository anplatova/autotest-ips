...
class LoginPage extends PageObject {
    ...
    public async loginComment(auth: { commentLogin: string, commentPassword: string }): Promise<void> {
        await this.waitForDisplaydLoginForm()
        await this.setLogin(auth.commentLogin)
        await this.setPassword(auth.commentPassword)
        await this.submit()
    }
